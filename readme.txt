...
* Adds hover, focus, and reduced-motion states consistent with the RESA interface.
* Extends regression coverage for the updated removal control.
...
* Aligns each colored status dot directly beside its label.
* Refines number sizing and adds layout regression coverage.
...
* Constrains the WordPress admin-menu icon to a readable 20 by 20 pixel tile.
* Extends regression coverage for the menu icon size guard.

= 2.0.0-beta.5 =
* Connects the official square RESA icon to the top-level WordPress admin menu.
* Adds regression coverage for logo files and dashboard/menu asset wiring.

= 2.0.0-beta.4 =
* Adds the official RESA logo and square plugin icon with transparent backgrounds.
* Uses the new icon in the unified dashboard header.
* Adds the RESA visual identity to the GitHub documentation.
